defmodule PubsubtestWeb.RoomChannel do
  use Phoenix.Channel
  ...
  def join("room:" <> game_id, _message, socket) do
  ...
  def handle_in("draw", _params = %{"position" => position}, socket) do
    drawing_result =
